...
//
//       Instance Name:              spram_hd_32x8192
//       Words:                      8192
//       Bits:                       32
//       Mux:                        8
//       Drive:                      6
...
//       
//       Creation Date:  Tue Sep 22 20:50:54 2020
//       Version: 	r1p0
//
...
module datapath_latch_spram_hd_32x8192 (CLK,Q_update,D_update,SE,SI,D,DFTRAMBYP,mem_path,XQ,Q);
...
endmodule // datapath_latch_spram_hd_32x8192
...
`ifdef POWER_PINS
module spram_hd_32x8192 (VDDCE, VDDPE, VSSE, CENY, WENY, AY, Q, SO, CLK, CEN, WEN,
    A, D, EMA, EMAW, TEN, TCEN, TWEN, TA, TD, RET1N, SI, SE, DFTRAMBYP);
`else
module spram_hd_32x8192 (CENY, WENY, AY, Q, SO, CLK, CEN, WEN, A, D, EMA, EMAW, TEN,
...
`endif
  ...
  reg NOT_A5, NOT_A4, NOT_A3, NOT_A2, NOT_A1, NOT_A0, NOT_D31, NOT_D30, NOT_D29, NOT_D28;
  reg NOT_D27, NOT_D26, NOT_D25, NOT_D24, NOT_D23, NOT_D22, NOT_D21, NOT_D20, NOT_D19;
  reg NOT_D18, NOT_D17, NOT_D16, NOT_D15, NOT_D14, NOT_D13, NOT_D12, NOT_D11, NOT_D10;
  reg NOT_D9, NOT_D8, NOT_D7, NOT_D6, NOT_D5, NOT_D4, NOT_D3, NOT_D2, NOT_D1, NOT_D0;
  reg NOT_EMA2, NOT_EMA1, NOT_EMA0, NOT_EMAW1, NOT_EMAW0, NOT_TEN, NOT_TCEN, NOT_TWEN;
  reg NOT_TA12, NOT_TA11, NOT_TA10, NOT_TA9, NOT_TA8, NOT_TA7, NOT_TA6, NOT_TA5, NOT_TA4;
  reg NOT_TA3, NOT_TA2, NOT_TA1, NOT_TA0, NOT_TD31, NOT_TD30, NOT_TD29, NOT_TD28, NOT_TD27;
  ...
  reg NOT_TD1, NOT_TD0, NOT_SI1, NOT_SI0, NOT_SE, NOT_DFTRAMBYP, NOT_RET1N;
...
`endif
  ...
  datapath_latch_spram_hd_32x8192 uDQ0 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(SI_int[0]), .D(D_int_bmux[0]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[0]), .XQ(XQ), .Q(Q_int[0]));
  datapath_latch_spram_hd_32x8192 uDQ1 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[0]), .D(D_int_bmux[1]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[1]), .XQ(XQ), .Q(Q_int[1]));
  datapath_latch_spram_hd_32x8192 uDQ2 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[1]), .D(D_int_bmux[2]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[2]), .XQ(XQ), .Q(Q_int[2]));
  datapath_latch_spram_hd_32x8192 uDQ3 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[2]), .D(D_int_bmux[3]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[3]), .XQ(XQ), .Q(Q_int[3]));
  datapath_latch_spram_hd_32x8192 uDQ4 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[3]), .D(D_int_bmux[4]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[4]), .XQ(XQ), .Q(Q_int[4]));
  datapath_latch_spram_hd_32x8192 uDQ5 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[4]), .D(D_int_bmux[5]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[5]), .XQ(XQ), .Q(Q_int[5]));
  datapath_latch_spram_hd_32x8192 uDQ6 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[5]), .D(D_int_bmux[6]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[6]), .XQ(XQ), .Q(Q_int[6]));
  datapath_latch_spram_hd_32x8192 uDQ7 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[6]), .D(D_int_bmux[7]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[7]), .XQ(XQ), .Q(Q_int[7]));
  datapath_latch_spram_hd_32x8192 uDQ8 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[7]), .D(D_int_bmux[8]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[8]), .XQ(XQ), .Q(Q_int[8]));
  datapath_latch_spram_hd_32x8192 uDQ9 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[8]), .D(D_int_bmux[9]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[9]), .XQ(XQ), .Q(Q_int[9]));
  datapath_latch_spram_hd_32x8192 uDQ10 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[9]), .D(D_int_bmux[10]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[10]), .XQ(XQ), .Q(Q_int[10]));
  datapath_latch_spram_hd_32x8192 uDQ11 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[10]), .D(D_int_bmux[11]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[11]), .XQ(XQ), .Q(Q_int[11]));
  datapath_latch_spram_hd_32x8192 uDQ12 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[11]), .D(D_int_bmux[12]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[12]), .XQ(XQ), .Q(Q_int[12]));
  datapath_latch_spram_hd_32x8192 uDQ13 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[12]), .D(D_int_bmux[13]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[13]), .XQ(XQ), .Q(Q_int[13]));
  datapath_latch_spram_hd_32x8192 uDQ14 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[13]), .D(D_int_bmux[14]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[14]), .XQ(XQ), .Q(Q_int[14]));
  datapath_latch_spram_hd_32x8192 uDQ15 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[14]), .D(D_int_bmux[15]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[15]), .XQ(XQ), .Q(Q_int[15]));
  datapath_latch_spram_hd_32x8192 uDQ16 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[17]), .D(D_int_bmux[16]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[16]), .XQ(XQ), .Q(Q_int[16]));
  datapath_latch_spram_hd_32x8192 uDQ17 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[18]), .D(D_int_bmux[17]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[17]), .XQ(XQ), .Q(Q_int[17]));
  datapath_latch_spram_hd_32x8192 uDQ18 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[19]), .D(D_int_bmux[18]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[18]), .XQ(XQ), .Q(Q_int[18]));
  datapath_latch_spram_hd_32x8192 uDQ19 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[20]), .D(D_int_bmux[19]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[19]), .XQ(XQ), .Q(Q_int[19]));
  datapath_latch_spram_hd_32x8192 uDQ20 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[21]), .D(D_int_bmux[20]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[20]), .XQ(XQ), .Q(Q_int[20]));
  datapath_latch_spram_hd_32x8192 uDQ21 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[22]), .D(D_int_bmux[21]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[21]), .XQ(XQ), .Q(Q_int[21]));
  datapath_latch_spram_hd_32x8192 uDQ22 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[23]), .D(D_int_bmux[22]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[22]), .XQ(XQ), .Q(Q_int[22]));
  datapath_latch_spram_hd_32x8192 uDQ23 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[24]), .D(D_int_bmux[23]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[23]), .XQ(XQ), .Q(Q_int[23]));
  datapath_latch_spram_hd_32x8192 uDQ24 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[25]), .D(D_int_bmux[24]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[24]), .XQ(XQ), .Q(Q_int[24]));
  datapath_latch_spram_hd_32x8192 uDQ25 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[26]), .D(D_int_bmux[25]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[25]), .XQ(XQ), .Q(Q_int[25]));
  datapath_latch_spram_hd_32x8192 uDQ26 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[27]), .D(D_int_bmux[26]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[26]), .XQ(XQ), .Q(Q_int[26]));
  datapath_latch_spram_hd_32x8192 uDQ27 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[28]), .D(D_int_bmux[27]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[27]), .XQ(XQ), .Q(Q_int[27]));
  datapath_latch_spram_hd_32x8192 uDQ28 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[29]), .D(D_int_bmux[28]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[28]), .XQ(XQ), .Q(Q_int[28]));
  datapath_latch_spram_hd_32x8192 uDQ29 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[30]), .D(D_int_bmux[29]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[29]), .XQ(XQ), .Q(Q_int[29]));
  datapath_latch_spram_hd_32x8192 uDQ30 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[31]), .D(D_int_bmux[30]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[30]), .XQ(XQ), .Q(Q_int[30]));
  datapath_latch_spram_hd_32x8192 uDQ31 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(SI_int[1]), .D(D_int_bmux[31]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[31]), .XQ(XQ), .Q(Q_int[31]));
...
`endif
 ...
 wire  CLK_;
  ...
  buf B95(D_[30], D[30]);
  buf B96(D_[31], D[31]);
  buf B97(EMA_[0], EMA[0]);
  buf B98(EMA_[1], EMA[1]);
  buf B99(EMA_[2], EMA[2]);
  buf B100(EMAW_[0], EMAW[0]);
  buf B101(EMAW_[1], EMAW[1]);
  buf B102(TEN_, TEN);
  buf B103(TCEN_, TCEN);
  buf B104(TWEN_, TWEN);
  buf B105(TA_[0], TA[0]);
  ...
  buf B113(TA_[8], TA[8]);
  buf B114(TA_[9], TA[9]);
  buf B115(TA_[10], TA[10]);
  buf B116(TA_[11], TA[11]);
  buf B117(TA_[12], TA[12]);
  buf B118(TD_[0], TD[0]);
  buf B119(TD_[1], TD[1]);
  buf B120(TD_[2], TD[2]);
  buf B121(TD_[3], TD[3]);
  ...
  buf B126(TD_[8], TD[8]);
  buf B127(TD_[9], TD[9]);
  buf B128(TD_[10], TD[10]);
  buf B129(TD_[11], TD[11]);
  buf B130(TD_[12], TD[12]);
  buf B131(TD_[13], TD[13]);
  buf B132(TD_[14], TD[14]);
  buf B133(TD_[15], TD[15]);
  buf B134(TD_[16], TD[16]);
  buf B135(TD_[17], TD[17]);
  buf B136(TD_[18], TD[18]);
  buf B137(TD_[19], TD[19]);
  buf B138(TD_[20], TD[20]);
  buf B139(TD_[21], TD[21]);
  buf B140(TD_[22], TD[22]);
  buf B141(TD_[23], TD[23]);
  buf B142(TD_[24], TD[24]);
  buf B143(TD_[25], TD[25]);
  buf B144(TD_[26], TD[26]);
  buf B145(TD_[27], TD[27]);
  buf B146(TD_[28], TD[28]);
  buf B147(TD_[29], TD[29]);
  buf B148(TD_[30], TD[30]);
  buf B149(TD_[31], TD[31]);
  buf B150(RET1N_, RET1N);
  buf B151(SI_[0], SI[0]);
  buf B152(SI_[1], SI[1]);
  buf B153(SE_, SE);
  buf B154(DFTRAMBYP_, DFTRAMBYP);
...
`endif
 ...
 wire  CLK_;
  ...
  buf B165(AY[8], AY_[8]);
  buf B166(AY[9], AY_[9]);
  buf B167(AY[10], AY_[10]);
  buf B168(AY[11], AY_[11]);
  buf B169(AY[12], AY_[12]);
  buf B170(Q[0], Q_[0]);
  buf B171(Q[1], Q_[1]);
  buf B172(Q[2], Q_[2]);
  buf B173(Q[3], Q_[3]);
  ...
  buf B250(D_[30], D[30]);
  buf B251(D_[31], D[31]);
  buf B252(EMA_[0], EMA[0]);
  buf B253(EMA_[1], EMA[1]);
  buf B254(EMA_[2], EMA[2]);
  buf B255(EMAW_[0], EMAW[0]);
  buf B256(EMAW_[1], EMAW[1]);
  buf B257(TEN_, TEN);
  buf B258(TCEN_, TCEN);
  buf B259(TWEN_, TWEN);
  buf B260(TA_[0], TA[0]);
  ...
  buf B268(TA_[8], TA[8]);
  buf B269(TA_[9], TA[9]);
  buf B270(TA_[10], TA[10]);
  buf B271(TA_[11], TA[11]);
  buf B272(TA_[12], TA[12]);
  buf B273(TD_[0], TD[0]);
  buf B274(TD_[1], TD[1]);
  buf B275(TD_[2], TD[2]);
  buf B276(TD_[3], TD[3]);
  ...
  buf B281(TD_[8], TD[8]);
  buf B282(TD_[9], TD[9]);
  buf B283(TD_[10], TD[10]);
  buf B284(TD_[11], TD[11]);
  buf B285(TD_[12], TD[12]);
  buf B286(TD_[13], TD[13]);
  buf B287(TD_[14], TD[14]);
  buf B288(TD_[15], TD[15]);
  buf B289(TD_[16], TD[16]);
  buf B290(TD_[17], TD[17]);
  buf B291(TD_[18], TD[18]);
  buf B292(TD_[19], TD[19]);
  buf B293(TD_[20], TD[20]);
  buf B294(TD_[21], TD[21]);
  buf B295(TD_[22], TD[22]);
  buf B296(TD_[23], TD[23]);
  buf B297(TD_[24], TD[24]);
  buf B298(TD_[25], TD[25]);
  buf B299(TD_[26], TD[26]);
  buf B300(TD_[27], TD[27]);
  buf B301(TD_[28], TD[28]);
  buf B302(TD_[29], TD[29]);
  buf B303(TD_[30], TD[30]);
  buf B304(TD_[31], TD[31]);
  buf B305(RET1N_, RET1N);
  buf B306(SI_[0], SI[0]);
  buf B307(SI_[1], SI[1]);
  buf B308(SE_, SE);
  buf B309(DFTRAMBYP_, DFTRAMBYP);
