...
file_ntt = open("./testcases/intt_cf.v", "w")
...
file_ntt.write ("uartm_write         (.addr(GPCFG_COMMNDFIFO_ADDR),  .data({8'h76, FHEMEM5_BASE[31:24], FHEMEM0_BASE[31:24], FHEMEM0_BASE[31:24]}));\n")
...
file_ntt.write ("uartm_write         (.addr(GPCFG_COMMNDFIFO_ADDR),  .data({8'h32, FHEMEM4_BASE[31:24], FHEMEM0_BASE[31:24], FHEMEM0_BASE[31:24]}));\n")
