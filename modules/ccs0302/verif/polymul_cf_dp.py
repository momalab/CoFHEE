...
barretk   = 2*math.ceil(math.log(modulus, 2))
...
file_ntt = open("./testcases/polymul_cf_dp.v", "w")
...
file_ntt.write ("uartm_write    (.addr(GPCFG_FHECTL2),          .data({FHEMEM3_BASE[31:24], FHEMEM3_BASE[31:24], FHEMEM0_BASE[31:24], FHEMEM0_BASE[31:24]}));\n")
...
file_ntt.write ("uartm_write    (.addr(GPCFG_COMMNDFIFO_ADDR),  .data({8'hC1, FHEMEM2_BASE[31:24], FHEMEM0_DP_BASE[31:24], FHEMEM0_BASE[31:24]}));\n")
file_ntt.write ("$display(\" << INFO: Triggered NTT A\");\n");

file_ntt.write ("uartm_write    (.addr(GPCFG_COMMNDFIFO_ADDR),  .data({8'hC1, FHEMEM0_BASE[31:24], FHEMEM1_DP_BASE[31:24], FHEMEM1_BASE[31:24]}));\n")
file_ntt.write ("$display(\" << INFO: Triggered NTT B\");\n");

file_ntt.write ("uartm_write    (.addr(GPCFG_COMMNDFIFO_ADDR),  .data({8'h43, FHEMEM1_BASE[31:24], FHEMEM2_BASE[31:24],    FHEMEM0_BASE[31:24]}));\n")
file_ntt.write ("$display(\" << INFO: Triggered MUL A * B\");\n");

file_ntt.write ("uartm_write    (.addr(GPCFG_COMMNDFIFO_ADDR),  .data({8'h46, FHEMEM0_BASE[31:24], FHEMEM1_BASE[31:24],    FHEMEM1_BASE[31:24]}));\n")
file_ntt.write ("$display(\" << INFO: Triggered CMUL\");\n");

file_ntt.write ("uartm_write    (.addr(GPCFG_COMMNDFIFO_ADDR),  .data({8'h82, FHEMEM1_BASE[31:24], FHEMEM0_DP_BASE[31:24], FHEMEM0_BASE[31:24]}));\n")
