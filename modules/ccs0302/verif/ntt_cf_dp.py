...
file_ntt = open("./testcases/ntt_cf_dp.v", "w")
...
file_ntt.write ("uartm_write         (.addr(GPCFG_FHECTL2),       .data({FHEMEM1_BASE[31:24], FHEMEM3_BASE[31:24], FHEMEM0_DP_BASE[31:24], FHEMEM0_BASE[31:24]}));\n")
...
#file_ntt.write ("uartm_write         (.addr(GPCFG_FHECTL3_ADDR),  .data(32'h0200_0101));\n")
