...
file_ntt.write ("  uartm_write_128     (.addr(FHEMEM2_BASE + 16*i),  .data(coef[i]));\n")
file_ntt.write ("end\n")
...
file_ntt.write ("uartm_write         (.addr(GPCFG_FHECTL2),      .data({FHEMEM6_BASE[31:24], FHEMEM2_BASE[31:24], FHEMEM5_BASE[31:24], FHEMEM2_BASE[31:24]}));\n")
